...
#     # Define the new, correct quantization configuration
...
#     print("Started loading 4-bit quantized model with BitsAndBytesConfig...")
...
#     # This assertion is much more likely to pass now that the model is quantized
#     # and PyTorch can correctly see and use the GPU.
#     assert ('cpu' not in model.hf_device_map.values())

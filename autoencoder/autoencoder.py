...
#    The goal of the algorithm would be to minimise this combined (optionally weighted) loss 4
# 4. Invertible function instead of a vanilla autoencoder --> the model should be able to reconstruct properly 
